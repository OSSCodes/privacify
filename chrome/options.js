document.addEventListener("DOMContentLoaded", () => {
  ...
  function loadSettings() {
    chrome.storage.local.get(['patterns', 'enabledDomains', 'showToast', 'toastPosition','pasteWarning'], (data) => {
      ...
      document.getElementById('pasteWarning').checked = pasteWarning;
  ...
  document.getElementById('pasteWarning').addEventListener('change', (e) => {
    const pasteWarning = e.target.checked;
    chrome.storage.local.set({ pasteWarning });
  });
